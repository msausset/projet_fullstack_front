...
// ----------------------------------------------------------------------------------------- NAVBAR 
    ...
    <nav className="text-center bg-white drop-shadow-lg h-30">
      <div className="flex m-auto mt-3 place-items-center place-content-center w-2/3">
...
{/* ---------------------------------------------------------------------------------------- ONGLET ACCUEIL */}
        ...
        <Link to="/" className="grow border-solid border-l-2">
...
{/* ---------------------------------------------------------------------------------------- ONGLET ANNONCES */}
        ...
        <Link to="/annonces" className="grow border-solid border-l-2">
          <div className="flex-wrap hover:underline hover:mt-5">
          <div className="-mt-5">
            <img
              alt="annonce"
...
{/* ---------------------------------------------------------------------------------------- ONGLET NOUVELLE ANNONCE */}
        ...
        <Link to="/nouvelle-annonce" className="grow border-solid border-l-2">
          <div className="flex-wrap hover:underline hover:mt-5">
          <div className="-mt-5">
            <img
...
{/* ---------------------------------------------------------------------------------------- ONGLET CONNEXION */}
        ...
        <Link to="/connexion" className="grow border-solid border-l-2">
          <div className="flex-wrap hover:underline hover:mt-5">
          <div className="-mt-5">
            <img
              alt="connexion"
...
{/* ---------------------------------------------------------------------------------------- ONGLET DECONNEXION */}
        ...
        <Link to="/deconnexion" className="grow border-solid border-l-2">
          <div className="flex-wrap hover:underline hover:mt-5">
          <div className="-mt-5">
            <img
              alt="deconnexion"
...
{/* ---------------------------------------------------------------------------------------- ONGLET MON COMPTE */}
        ...
        <Link to="/mon-compte" className="grow border-solid border-l-2">
          <div className="flex-wrap hover:underline hover:mt-5">
          <div className="-mt-5">
            <img
              alt="compte"
