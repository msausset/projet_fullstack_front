    ...
    <div>
      <div className="w-[60vw] min-h-screen pb-[1vw] m-auto shadow-2xl bg-white opacity-95">
        ...
        <div className="mr-[2vw] ml-[2vw] pt-10">
          ...
          <div className="rounded-md mb-10 border border-black border-2 bg-slate-200">
            {/* ------------------------------------------------------------------------------------------ DIV PHOTO */}

            <div className="h-[30vw] m-1 text-center">
              <img src={mustang} className="w-full h-[30vw]" alt="mustang" />
            </div>

            {/* ------------------------------------------------------------------------------------------ DIV TITRE */}

            <div className="text-4xl h-[3vw] m-1 text-center">
              <span>Mustang Shelby GT500 - 1967</span>
            </div>

            {/* ------------------------------------------------------------------------------------------ DIV DESCRIPTION */}

            <div className="rounded-xl w-[40vw] m-auto text-center bg-slate-300">
            ...
            <div className=" w-[20vw] m-auto pt-10 my-5 text-center">
              <span className="text-4xl bg-yellow-200">25.999€</span>
            </div>
